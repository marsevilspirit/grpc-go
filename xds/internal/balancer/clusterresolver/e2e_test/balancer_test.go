...
import (
	...
	"github.com/dubbogo/grpc-go/xds/internal/balancer/outlierdetection"
	...
	_ "github.com/dubbogo/grpc-go/xds/internal/balancer/cdsbalancer" // Register the "cds_experimental" LB policy.
)
