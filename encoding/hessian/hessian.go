...
func init() {
	encoding.RegisterCodecV2(encoding.NewPBWrapperTwoWayCodec("hessian2", NewHessianCodec(), raw_proto.NewProtobufCodec()))
}
...
func (h *HessianCodeC) Marshal(v any) ([]byte, error) {
...
func (h *HessianCodeC) Unmarshal(data []byte, v any) error {
