...
func init() {
	encoding.RegisterCodecV2(NewPBTwoWayCodec())
}
...
func NewPBTwoWayCodec() encoding.TwoWayCodecV2 {
...
func (h *PBTwoWayCodec) MarshalRequest(v interface{}) (mem.BufferSlice, error) {
	return h.codec.Marshal(v)
}

// UnmarshalRequest unmarshal bytes @data to interface
func (h *PBTwoWayCodec) UnmarshalRequest(data mem.BufferSlice, v interface{}) error {
	return h.codec.Unmarshal(data, v)
}

// MarshalResponse marshal interface @v to []byte
func (h *PBTwoWayCodec) MarshalResponse(v interface{}) (mem.BufferSlice, error) {
	return h.codec.Marshal(v)
}

// UnmarshalResponse unmarshal bytes @data to interface
func (h *PBTwoWayCodec) UnmarshalResponse(data mem.BufferSlice, v interface{}) error {
	return h.codec.Unmarshal(data, v)
}
